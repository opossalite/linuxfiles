pcall(require, "luarocks.loader") --load packages installed through luarocks if installed
local gears = require("gears") --no idea, standard awesome library
local awful = require("awful") --no idea, standard awesoem library
...
require("awful.hotkeys_popup.keys") --hotkeys help widget for vim and other apps

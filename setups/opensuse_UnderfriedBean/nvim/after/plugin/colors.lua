...
-- Zig
vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {pattern = "*.zig", callback = function()
    ColorRefresh("tender")
end})
...
-- TYPESCRIPT + SVELTE
vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {pattern = "*.ts", callback = function()
    ColorRefresh("nightfly")
end})
vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {pattern = "*.tsx", callback = function()
    ColorRefresh("nightfly")
end})
vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {pattern = "*.svelte", callback = function()
    ColorRefresh("nightfly")
end})
